...
"""
This script tests a Gaussian Mixture Model (GMM) to classify audio files as containing drone or unknown sounds.

Usage:
    python test/test_gmm.py --data-dir <data_directory> --model-path <model_path>
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Test GMM model on held-out test set")
    parser.add_argument("--data-dir", default="data", type=str, help="Dataset root directory")
    parser.add_argument("--model-path", default="models/gmm_model.joblib", type=str, help="Path to trained GMM model")
