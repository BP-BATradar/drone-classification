...
"""
This script tests a Support Vector Machine (SVM) model to classify audio files as containing drone or unknown sounds.

Usage:
    python test/test_svm.py --data-dir <data_directory> --model-path <model_path>
"""
