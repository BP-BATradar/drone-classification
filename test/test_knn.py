...
def main() -> None:
    parser = argparse.ArgumentParser(description="Test KNN model on held-out test set")
    parser.add_argument("--data-dir", default="data/train", type=str, help="Dataset root directory")
    parser.add_argument("--model-path", default="models/knn_model.joblib", type=str, help="Path to trained KNN model")
